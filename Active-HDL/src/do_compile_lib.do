...
#do "D:\Telops\Common_HDL\VHDL-200x\IEEE_proposed\src\compile_lib.do"			   
...
do "D:\Telops\Common_HDL\VHDL-2008\IEEE_proposed_2010\src\compile_lib.do"			   
...
do "D:\Telops\Common_HDL\Wishbone\wb_uart_lite\build\do_compile.do"

-- I2C
acom  -work Common_HDL "$LIBPATH\I2C\i2c_master.vhd"
acom  -work Common_HDL "$LIBPATH\I2C\temp_reader.vhd" 
...
acom  -work Common_HDL "$LIBPATH\SPI\new_spi_master.vhd"
...
acom  -work Common_HDL "$LIBPATH\LocalLink\Math\neg_float32\neg_float32.vhd"
...
importbdesymbols -lib common_hdl d:\Telops\Common_hdl\symbols\*.bds -overwrite
