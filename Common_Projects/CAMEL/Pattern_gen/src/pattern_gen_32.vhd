         ...
         case diag_state is 
            ...
            when TriggerFrame =>
               case pg_ctrl_i.FrameType is
                  when ROIC_CAMERA_FRAME | ROIC_HEADER_FRAME | ROIC_DCUBE_FRAME | ROIC_FOOTER_FRAME =>
                     if ctrl_fip = '1' or data_fip = '1' then
                        pg_ctrl_i.Trig <= '0';
                        diag_state := DiagFrameInProgress;
                        if pg_ctrl_i.FrameType = ROIC_DCUBE_FRAME then
                  ...
                  if use_ext_input = '0' then
                     ...
                     if (TagCnt > pg_ctrl_i.TagSize) then  -- Is the tag necessary or done?
                        ...
                        case pg_ctrl_i.DiagMode is
                           ...
                           when PG_BSQ_XYZ | PG_BSQ_COLD | PG_BSQ_HOT | PG_BSQ_SCENE | PG_BIP_XYZ =>
