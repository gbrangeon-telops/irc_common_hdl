...
acom "$DSN/src/data_processing_board.bde"
acom "$DSN/src/dpb_testbench_controller.vhd"
acom "$DSN/../Pattern_gen/src/pattern_gen_32.vhd"
acom "$DSN/src/roic_fpga_402.bde"
acom "$DSN/src/stimulus.bde"	   

#acom "$DSN/src/DPB_Alone_TB/clink_board_dummy.bde"
#acom "$DSN/src/DPB_Alone_TB/DPB_Alone_TB.bde"	

#acom $DSN/src/DDR_Structure.vhd


#acom "$DSN/src/aurora_tb/aurora_tb.bde"
#acom "$DSN/src/aurora_tb/aurora_tb_tb.vhd"
#acom "$DSN/src/aurora_tb/aurora_tb_v4_only.bde"
