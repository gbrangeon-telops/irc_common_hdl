...
# Serial TX
comp -include "$COMMON_HDL/Common_Projects/IRCDEV/Inter_FPGA_Link/src/SerialLink_TX.vhd"
comp -include "$dsn/compile/syncseriallink_tx.vhd"
# Serial RX
comp -include "$COMMON_HDL/Common_Projects/IRCDEV/Inter_FPGA_Link/src/SerialLink_RX.vhd"
