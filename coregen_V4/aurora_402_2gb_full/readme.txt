readme.txt
Aurora Reference Design version 2.4
Date:  $Date: 2005/12/14 19:36:30 $
File:  $RCSfile: readme.ejava,v $
Rev:  $Revision: 1.1.2.6 $
==============================================================================================


    Thank you for choosing the Aurora Reference Design. This file contains
    information specific to the module you have just generated.  Refer to
    the Aurora Reference Design User Guide (ug061.pdf) and the Getting Started
...
==============================================================================================
    ...
    (1)     Summary of the parameters used to generate your Aurora Reference Design Module


    (2)     Overview of the Aurora Reference Design directory structure
...
===============================================================================================
    ...
    Section (1) : Summary of the parameters used to generate your Aurora Reference Design Module
    --------------------------------------------------------------------------------------------
    ...
    ----------
    HDL used                    :   VHDL
    Top level module            :   src/aurora_402_2gb_full.vhd
    Lanes (MGTs) in channel     :   2
    Bytes in parallel interface :   8
    Interface mode              :   Framing (LocalLink)
    Duplex or Simplex           :   Duplex
    Device used                 :   xc4vfx100
...
===============================================================================================
    ...
    Section (2)  Overview of the Aurora Reference Design directory structure
    ------------------------------------------------------------------------
    ...
    |---aurora_402_2gb_full
        ...
        |---src/
        |   |
        |   |---aurora_402_2gb_full.vhd
        |   |
        |   |---[remaining Aurora module VHDL source code]
        |
        |---ucf/
        |   |
        |   |---aurora_402_2gb_full.ucf    [Contraints for Aurora module. Include these in your final design]
        |   |
        ...
        |        not including the cc_manager or the clock module]
        |
        |---scripts/
        |   |
        |   |---make_aurora.pl
...
===============================================================================================
    ...
    (d) Channel does not come up or is flaky in hardware
        ...
        - Make sure you copied all the constraints from the aurora_402_2gb_full/ucf/aurora_402_2gb_full.ucf
        ...
        - If you are using a 4-byte lane module in V2Pro, make sure your USER_CLK_2X_N signal is exactly twice your
          ...
          half of your reference clock. If you use the clock module provided in aurora_402_2gb_full/clock_module,
