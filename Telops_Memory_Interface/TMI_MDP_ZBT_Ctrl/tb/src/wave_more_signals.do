...
add wave -noreg -logic {/MEMTEST_port2/tmi_dval_i}
...
add wave -noreg -logic {/U4/U1/TST/rd_dval_i}
add wave -noreg -hexadecimal -literal {/U4/U1/TST/rd_data_i}
add wave -noreg -logic {/U4/U1/TST/rd_dval_i_r1}
add wave -noreg -hexadecimal -literal {/U4/U1/TST/rd_data_i_r1}
add wave -noreg -logic {/U4/U1/TST/rd_dval_i_r2}
add wave -noreg -hexadecimal -literal {/U4/U1/TST/rd_data_i_r2}
add wave -noreg -hexadecimal -literal {/U4/U1/TST/data_golden}
add wave -noreg -hexadecimal -literal {/U4/U1/TST/data_golden_r1}
add wave -noreg -logic {/U4/U1/TST/self_test_proc/test_phase}
add wave -noreg -logic {/U4/U1/TST/self_test_proc/error_found}
add wave -noreg -logic {/U4/U1/TST/self_test_proc/error_found_r1}
...
add wave -noreg -logic {/U4/U1/TST/tmi_dval_i}
...
add wave -noreg -logic {/U4/U1/TUNE/DLY_EN}
add wave -noreg -logic {/U4/U1/TUNE/DLY_INC}
add wave -noreg -logic {/U4/U1/TUNE/dly_en_i}
add wave -noreg -logic {/U4/U1/TUNE/dly_inc_i}
...
add wave -noreg -logic -signed2 {/U4/U1/TUNE/auto_detect_proc/FinalDelay}
...
add wave -noreg -logic {/U4/U1/TUNE/extra_cycle_i}
add wave -noreg -logic {/U4/U1/TUNE/EXTRA_CYCLE}
