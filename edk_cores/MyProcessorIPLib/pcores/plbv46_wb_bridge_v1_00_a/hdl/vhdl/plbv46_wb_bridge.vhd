------------------------------------------------------------------------------
-- plbv46_wb_bridge.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
library plbv46_wb_bridge_v1_00_a;
use plbv46_wb_bridge_v1_00_a.user_logic;
...
entity plbv46_wb_bridge is
  ...
  (
    ...
    WB_DAT_O                       : out std_logic_vector(0 to C_SPLB_NATIVE_DWIDTH-1);
    WB_SEL_O                       : out std_logic_vector(0 to (C_SPLB_NATIVE_DWIDTH/8)-1);
    WB_CYC_O                       : out std_logic;
    WB_LOCK_O                      : out std_logic;
    WB_STB_O                       : out std_logic;
    WB_WE_O                        : out std_logic;
    WB_DAT_I                       : in  std_logic_vector(0 to C_SPLB_NATIVE_DWIDTH-1);
...
end entity plbv46_wb_bridge;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of plbv46_wb_bridge is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plbv46_wb_bridge_v1_00_a.user_logic
    generic map
    (
