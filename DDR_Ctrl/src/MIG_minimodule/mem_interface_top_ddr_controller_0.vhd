...
--            data_ila(111)            <= comp_done_r;
--            data_ila(110)            <= phy_Dly_Slct_Done;
--            data_ila(109)            <= init_done_int;
--            data_ila(108 downto 105) <= burst_cnt(3 downto 0);
...
--            data_ila( 84 downto  80) <= count5;
--            data_ila( 79)            <= auto_ref;
--            data_ila( 78 downto  77) <= chip_cnt;
--         end if;
--      end process;
