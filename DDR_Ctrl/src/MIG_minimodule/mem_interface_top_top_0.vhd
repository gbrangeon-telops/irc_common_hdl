...
--      );
--      
--      process(sys_rst, clk_0)
--      begin
--         if sys_rst = '1' then
--            data_ila <= (others => '0');
--         elsif clk_0'event and clk_0 = '1' then
--            data_ila(126 downto 111) <= rd_data_rise;  --16
--            data_ila(110 downto  95) <= rd_data_fall;  --16
--            data_ila( 94 downto  82) <= ctrl_ddr_address;--13
--            data_ila( 81 downto  80) <= ctrl_ddr_ba;   --2
--            data_ila( 79 downto  64) <= rd_out(15 downto 0);--16
--            data_ila( 63)            <= ctrl_ddr_ras_L;--1
--            data_ila( 62)            <= ctrl_ddr_cas_L;--1
--            data_ila( 61)            <= ctrl_ddr_we_L; --1
--            data_ila( 60 downto  45) <= wr_data_rise;  --16
--            data_ila( 44 downto  29) <= wr_data_fall;  --16
--            data_ila( 28 downto  27) <= rd_ok;
--            data_ila( 26 downto   0) <= af_addr(26 downto 0);--36
--         end if;
--      end process;
      READ_DATA_FIFO_OUT<=rd_out;
