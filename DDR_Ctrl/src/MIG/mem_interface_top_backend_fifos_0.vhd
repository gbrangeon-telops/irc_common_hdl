...
architecture arch of mem_interface_top_backend_fifos_0 is
  ...
  signal pattern_9            : std_logic_vector(143 downto 0);
  signal pattern_6            : std_logic_vector(143 downto 0);
...
begin
  ...
  pattern_9 <= X"9999_9999_9999_9999_9999_9999_9999_9999_9999";
  pattern_6 <= X"6666_6666_6666_6666_6666_6666_6666_6666_6666";
...
wr_data_fifo_161 : mem_interface_top_wr_data_fifo_16
  port map (
          clk0              => clk0,
          clk90             => clk90,
          rst               => rst,
          app_Wdf_data      => init_or_app_Wdf_data(63 downto 32),
...
wr_data_fifo_162 : mem_interface_top_wr_data_fifo_16
  port map (
          clk0              => clk0,
          clk90             => clk90,
          rst               => rst,
          app_Wdf_data      => init_or_app_Wdf_data(95 downto 64),
          app_mask_data     => app_mask_data(11 downto 8),
          app_Wdf_WrEn      => init_or_app_Wdf_WrEn,
          ctrl_Wdf_RdEn     => ctrl_Wdf_RdEn,
...
wr_data_fifo_163 : mem_interface_top_wr_data_fifo_16
  port map (
          clk0              => clk0,
          clk90             => clk90,
          rst               => rst,
          app_Wdf_data      => init_or_app_Wdf_data(127 downto 96),
          app_mask_data     => app_mask_data(15 downto 12),
          app_Wdf_WrEn      => init_or_app_Wdf_WrEn,
          ctrl_Wdf_RdEn     => ctrl_Wdf_RdEn,
...
wr_data_fifo_84 : mem_interface_top_wr_data_fifo_8
  port map (
          clk0              => clk0,
          clk90             => clk90,
          rst               => rst,
          app_Wdf_data      => init_or_app_Wdf_data(143 downto 128),
          app_mask_data     => app_mask_data(17 downto 16),
          app_Wdf_WrEn      => init_or_app_Wdf_WrEn,
          ctrl_Wdf_RdEn     => ctrl_Wdf_RdEn,
